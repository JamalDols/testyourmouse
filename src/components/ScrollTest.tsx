    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <Card
            ref={scrollAreaRef}
            className="h-96 overflow-hidden relative cursor-pointer bg-[#0a0a0f] border-cyan-500/30 hover:border-cyan-500/50 transition-colors"
            onWheel={handleWheel}
          >
            ...
            <div className="relative h-full flex flex-col items-center justify-center p-8">
              ...
              <p className="text-center text-cyan-400/70 mb-2 tracking-wide">
                [SCROLL_DETECTION_ZONE]
              </p>
            ...
            <div className="absolute left-8 top-8 bottom-8 w-2 bg-cyan-500/20 rounded-full overflow-hidden border border-cyan-500/30">
              <div
                className="absolute bottom-0 w-full bg-gradient-to-t from-cyan-500 to-purple-500 transition-all duration-300 rounded-full glow-cyan"
